          ...
          <v-toolbar flat color="white">
            ...
            <v-dialog v-model="comprobanteModal" max-width="1000px">
              <v-card>
                          ...
                          <tbody>
                            <tr>
                              <td id="cliente">
                                ...
                                <br />
                                <strong>Documento:</strong> {{persona.num_documento}}
                                <br />
                ...
                <v-card-actions>
                  <v-btn color="blue darken-1" flat @click="ocultarComprobante()">Cancelar</v-btn>
                </v-card-actions>
              </v-card>
            </v-dialog>
          </v-toolbar>
            ...
            <template>
              ...
              >
                ...
                <template v-slot:item.subtotal="{ item }">
                  <template
                    class="text-xs-center"
                  >$ {{(item.cantidad * item.precio)-item.descuento}}</template>
                </template>
